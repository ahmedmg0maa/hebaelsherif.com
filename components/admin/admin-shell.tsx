...
import { BookOpen, Calendar, Eye, Home, Layers3, LogOut, Menu, MessageSquare, ShoppingCart, Stethoscope, User, X } from "lucide-react"
...
const navigation = [
  ...
  { name: "التشخيص", href: "/admin/diagnostics", icon: Stethoscope },
